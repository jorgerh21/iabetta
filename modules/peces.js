export const PecesModule = {
        ...
        <div class="card card-custom border-secondary shadow-sm">
            <div class="table-responsive">
                <table class="table table-dark table-hover m-0">
                    ...
                    <tbody>
                        <tr v-for="pez in lista" :key="pez.id_pece" class="align-middle">
                            <td style="width: 60px;">
                            ...
                            <td class="small">{{ pez.fecha_ingreso }}</td>
                            <td>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select v-model="form.sexo" class="form-select custom-input">
                                    ...
                                    <option value="Alevín/Sin sexar">Alevín/Sin sexar</option>
                                </select>
                            </div>
                            <div class="col-md-4">
    ...
    methods: {
        ...
        prepararNuevo() {
            ...
            this.form = {
                id_pece: null,
                id_especie: this.especies[0]?.id_especie || null,
        ...
        prepararEdicion(pez) {
            ...
            this.archivoFoto = null;
            this.form = { ...pez };
            // Asegurar que fecha_ingreso esté en formato YYYY-MM-DD
        ...
        async guardar() {
            ...
            // Si hay foto nueva, usamos FormData
            if (this.archivoFoto) {
                ...
                // Para PUT, algunos servidores necesitan _method, pero mejor usamos POST con override
                if (this.editando) {
                    formData.append('_method', 'PUT');
                    metodo = 'POST'; // Simulamos PUT con POST + _method
                }
                body = formData;
            } else {
